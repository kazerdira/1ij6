...
# Example usage:
"""
from reliability.retry_handler import retry, async_retry, retry_on_model_error
import torch

# Basic retry
@retry(max_attempts=3, base_delay=1.0)
def download_model():
    # Downloads that might fail
    return whisper.load_model("base")

# Model-specific retry
@retry_on_model_error(max_attempts=3)
def run_inference(audio):
    # GPU operations that might OOM
